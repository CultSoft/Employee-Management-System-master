...
if((fp=fopen("employeeInfo.txt","rb+"))==NULL) //CultSoft
{
...
char username[10],password[10]; //CultSoft
printHead();
welcome();
printHead();
printf("\n\t\t\t\t  Login Screen");
...
if((ft=fopen("temp.txt","wb+"))==NULL)//CultSoft
{
    printf("\n\n\t\t\t\\t!!! ERROR !!!\n\t\t");
    system("pause");
     return fp;
...
if(flag==1)
    ...
    fflush(stdin);
    fgets(e.name,100,stdin); //fgets takes an extra \n character as input
    e.name[strlen(e.name)-1]='\0';//CultSoft
    ...
    printf("\n\n\t\tEnter Branch: ");
    fflush(stdin);
    fgets(e.branch,50,stdin);//CultSoft
    e.branch[strlen(e.branch)-1]='\0';
    ...
    printf("\n\n\t\tEnter Permanant Address: ");
    fflush(stdin);
    fgets(e.prtaddr,200,stdin);//CultSoft
    e.prtaddr[strlen(e.prtaddr)-1]='\0';
    ...
    fwrite(&e,sizeof(e),1,fp);//CultSoft
}
...
//================SEARCH EMPLOYEE==
void searchRecord(FILE *fp)//CultSoft
{printHead();
printf("\n\t\t\t\Search Employee");
...
{
    printHead();
     printf("\n\t\t\t\List of Employee From Dhaka");//CultSoft
    Employee e;
    int i,siz=sizeof(e);
...
{
    printHead();
    printf("\n\t\t\t\List of Employee of Other Branch");//CultSoft
    Employee e;
    int i,siz=sizeof(e);
